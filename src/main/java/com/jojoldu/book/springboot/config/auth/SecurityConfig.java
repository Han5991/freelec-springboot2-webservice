    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .headers().frameOptions().disable()
                //line 17~18 h2-console 화면을 사용하기 위해 해당 옵션들을 disable 합니다.
            .and()
            .authorizeRequests()
                //URl 별 권한관리를 설정하는 옵션의 시작점입니다.
                //authorizeRequests가 선언 되어야만 antMatchers옵션을 사용할 수 있습니다.
            .antMatchers("/", "/css/**", "/images/**", "/js/**", "/h2-console/**", "/profile").permitAll()
            .antMatchers("/api/v1/**").hasRole(Role.USER.name())
                //권한 관리 대상을 지정하는 옵션입니다.
                //URL, HTTP 메소드별로 관리가 가능합니다.
                //"/"등 지정된 URL들은 permitAll()옵션을 통해 전체 열람 관한을 주었습니다.
            ...
            .and()
            .oauth2Login()
                //OAth2 로그인 기능에 대한 여러 설정의 진입점입니다.
            .userInfoEndpoint()
